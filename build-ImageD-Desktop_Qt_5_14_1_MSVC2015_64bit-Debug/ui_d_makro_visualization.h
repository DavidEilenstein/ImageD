...
public:
    ...
    {
        D_MAKRO_Visualization->setWindowTitle(QCoreApplication::translate("D_MAKRO_Visualization", "MainWindow", nullptr));
        action_Add_Images->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Add Images", nullptr));
#if QT_CONFIG(shortcut)
        action_Add_Images->setShortcut(QCoreApplication::translate("D_MAKRO_Visualization", "Ctrl+O", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Clear_Stack->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Clear Stack", nullptr));
        action_Save_Single->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Save Single", nullptr));
#if QT_CONFIG(shortcut)
        action_Save_Single->setShortcut(QCoreApplication::translate("D_MAKRO_Visualization", "Ctrl+S", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Save_Stack->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Save Stack", nullptr));
#if QT_CONFIG(shortcut)
        action_Save_Stack->setShortcut(QCoreApplication::translate("D_MAKRO_Visualization", "Ctrl+Shift+S", nullptr));
#endif // QT_CONFIG(shortcut)
        action_AutoValRange->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Automatic Value Range: Min to Max", nullptr));
        actionMinimum->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Minimum", nullptr));
        actionNormal->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Normal", nullptr));
        actionMaximum->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Maximum", nullptr));
        actionFullscreen->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Fullscreen", nullptr));
        groupBox_Page->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Pages", nullptr));
        label_PageInfo_ValAtCursor->setText(QCoreApplication::translate("D_MAKRO_Visualization", "ValueAtCursor", nullptr));
        label_PageInfo_Range->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Range", nullptr));
        label_PageInfo_Size->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Size", nullptr));
        groupBox_Processing->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Processing", nullptr));
        label_Bin_Skip->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Ignores this page.", nullptr));
        label_Bin_Copy->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Copy the data without scaling.", nullptr));
        groupBox_Bin_Smooth->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Smooth", nullptr));
        label_2->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Size/Sigma:", nullptr));
        groupBox_Binarization->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Binarization", nullptr));
        label_3->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Threshold:", nullptr));
        groupBox_Bin_Segmentation->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Segmentation", nullptr));
        checkBox_Bin_InclBorder->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Include objects at border", nullptr));
        checkBox_Bin_InclNonSeed->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Include not seeded objects", nullptr));
        label->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Distance:", nullptr));
        groupBox_Reduce->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Reduce to", nullptr));
#if QT_CONFIG(whatsthis)
        groupBox_Bin_Paint->setWhatsThis(QCoreApplication::translate("D_MAKRO_Visualization", "<html><head/><body><p>Left-click on Image: Line to / Fill from position</p><p><br/></p><p>Right-click on Image: Start new line</p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
        groupBox_Bin_Paint->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Manually Paint", nullptr));
        pushButton_Bin_Paint_Reset->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Reset", nullptr));
        label_6->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Gamma:", nullptr));
        label_4->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Minimum:", nullptr));
        label_5->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Maximum:", nullptr));
        label_7->setText(QCoreApplication::translate("D_MAKRO_Visualization", "In", nullptr));
        label_8->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Out", nullptr));
        groupBox_Color->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Color", nullptr));
        label_Color_G->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Green", nullptr));
        label_Color_Preview->setText(QString());
        label_Color_B->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Blue", nullptr));
        label_Color_R->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Red", nullptr));
        label_Color_Alpha->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Alpha", nullptr));
        pushButton_ColorSet->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Select Color", nullptr));
        groupBox_Image->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Images", nullptr));
        pushButton_Add->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Add Images (Ctrl + O)", nullptr));
        pushButton_Clear->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Clear Stack", nullptr));
        groupBox_Output->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Output", nullptr));
        pushButton_SaveStack->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Save Stack (Ctrl + Shift + S)", nullptr));
        pushButton_SaveSingle->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Save Single (Ctrl + S)", nullptr));
        groupBox_Scalebar->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Scalebar", nullptr));
        doubleSpinBox_Scalebar_Barsize->setSuffix(QCoreApplication::translate("D_MAKRO_Visualization", "px", nullptr));
        label_Scalebar_Pixel->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Pixesize:", nullptr));
        doubleSpinBox_Scalebar_Pixelsize->setSuffix(QCoreApplication::translate("D_MAKRO_Visualization", "px", nullptr));
        lineEdit_Scalebar_Unit->setText(QCoreApplication::translate("D_MAKRO_Visualization", "px", nullptr));
        label_Scalebar_Unit->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Unit:", nullptr));
        label_Scalebar_Bar->setText(QCoreApplication::translate("D_MAKRO_Visualization", "Barsize:", nullptr));
        menuData->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Data", nullptr));
        menuMakros->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Presets", nullptr));
        menuWindow->setTitle(QCoreApplication::translate("D_MAKRO_Visualization", "Window", nullptr));
    } // retranslateUi
