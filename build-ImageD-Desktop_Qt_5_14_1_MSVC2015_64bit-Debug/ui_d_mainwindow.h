...
public:
    ...
    {
        D_MainWindow->setWindowTitle(QCoreApplication::translate("D_MainWindow", "D_MainWindow", nullptr));
        action_Smooth_Transformation->setText(QCoreApplication::translate("D_MainWindow", "Smooth Transformation", nullptr));
        action_Keep_Aspect_Ratio->setText(QCoreApplication::translate("D_MainWindow", "Keep Aspect Ratio", nullptr));
        action_Show_Minimize->setText(QCoreApplication::translate("D_MainWindow", "Minimize", nullptr));
#if QT_CONFIG(shortcut)
        action_Show_Minimize->setShortcut(QCoreApplication::translate("D_MainWindow", "F9", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Show_Normal->setText(QCoreApplication::translate("D_MainWindow", "Normal", nullptr));
#if QT_CONFIG(shortcut)
        action_Show_Normal->setShortcut(QCoreApplication::translate("D_MainWindow", "F10", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Show_Maximize->setText(QCoreApplication::translate("D_MainWindow", "Maximize", nullptr));
#if QT_CONFIG(shortcut)
        action_Show_Maximize->setShortcut(QCoreApplication::translate("D_MainWindow", "F11", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Show_Fullscreen->setText(QCoreApplication::translate("D_MainWindow", "Fullscreen", nullptr));
#if QT_CONFIG(shortcut)
        action_Show_Fullscreen->setShortcut(QCoreApplication::translate("D_MainWindow", "F12", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Update_All_Steps->setText(QCoreApplication::translate("D_MainWindow", "Update All Steps", nullptr));
#if QT_CONFIG(shortcut)
        action_Update_All_Steps->setShortcut(QCoreApplication::translate("D_MainWindow", "F5", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Update_Times->setText(QCoreApplication::translate("D_MainWindow", "Update Times", nullptr));
#if QT_CONFIG(shortcut)
        action_Update_Times->setShortcut(QCoreApplication::translate("D_MainWindow", "F7", nullptr));
#endif // QT_CONFIG(shortcut)
        action_Autoupdate_Times_on_Steps->setText(QCoreApplication::translate("D_MainWindow", "Autoupdate Times on update all steps", nullptr));
        action_Autoupdate_Times_on_TimesSettings->setText(QCoreApplication::translate("D_MainWindow", "Autoupdate Times on Times settings changed", nullptr));
        action_Set_Step_Pos->setText(QCoreApplication::translate("D_MainWindow", "Set Position", nullptr));
        action_Test_Statistic_Function->setText(QCoreApplication::translate("D_MainWindow", "Test Statistic Function", nullptr));
        action_Test_Quatile_Access->setText(QCoreApplication::translate("D_MainWindow", "Test Quatile Access", nullptr));
#if QT_CONFIG(tooltip)
        action_Test_Quatile_Access->setToolTip(QCoreApplication::translate("D_MainWindow", "Test Quatile Access", nullptr));
#endif // QT_CONFIG(tooltip)
        action_Stat_Tester->setText(QCoreApplication::translate("D_MainWindow", "Open Stat-Tester Window", nullptr));
        action_Steps_Normal_Size->setText(QCoreApplication::translate("D_MainWindow", "Normal Size", nullptr));
        action_Test_D_VisDat->setText(QCoreApplication::translate("D_MainWindow", "Test D_VisDat", nullptr));
        actionTest_ND_Mat_load_and_display->setText(QCoreApplication::translate("D_MainWindow", "Test_ ND_Mat load and display", nullptr));
        action_Test_1D_EDT->setText(QCoreApplication::translate("D_MainWindow", "Test 1D EDT", nullptr));
        action_StepDefault_Autoupdate_Steps_on_Settings_changed->setText(QCoreApplication::translate("D_MainWindow", "Autoupdate Settings changed", nullptr));
        action_StepDefault_Viewer_Smooth_Transformation->setText(QCoreApplication::translate("D_MainWindow", "Viewer Smooth Transformation", nullptr));
        action_StepDefault_Viewer_Keep_Aspect_Ratio->setText(QCoreApplication::translate("D_MainWindow", "Viewer Keep Aspect Ratio", nullptr));
        action_StepDefault_Skip_when_all_Steps_are_updated->setText(QCoreApplication::translate("D_MainWindow", "Skip when all Steps are updated", nullptr));
        action_StepDefault_Connect_Plane_Position->setText(QCoreApplication::translate("D_MainWindow", "Connect Plane Position", nullptr));
        action_StepDefault_Connect_Steps_Zoom->setText(QCoreApplication::translate("D_MainWindow", "Connect Steps Zoom", nullptr));
        actionTest_DPF_Writer->setText(QCoreApplication::translate("D_MainWindow", "Test DPF Writer", nullptr));
        groupBox_Plugins->setTitle(QCoreApplication::translate("D_MainWindow", "Plugins", nullptr));
        pushButton_PluginLaunch->setText(QCoreApplication::translate("D_MainWindow", "Launch", nullptr));
        groupBox_Analysis->setTitle(QCoreApplication::translate("D_MainWindow", "Other", nullptr));
        pushButton_Analysis_Add->setText(QCoreApplication::translate("D_MainWindow", "Add Analysis", nullptr));
        groupBox_References->setTitle(QCoreApplication::translate("D_MainWindow", "References", nullptr));
#if QT_CONFIG(tooltip)
        pushButton_Ref_OBV->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>University of applied sciences Darmstadt<br/>Machine vision and photonics</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_OBV->setText(QString());
        pushButton_Ref_Docs->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_OpenCV->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>OpenCV</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_OpenCV->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_Qt->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>Qt-Creator</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_Qt->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_Biophysics->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>GSI Helmholzfacility for heavy ion reserach<br/>Biophysics</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_Biophysics->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_Citation->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>Citation</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_Citation->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_Contact->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>Contact developer</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_Contact->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_Licence->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>Licence</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_Licence->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_GSI->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>GSI Helmholzfacility for heavy ion reserach</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_GSI->setText(QString());
#if QT_CONFIG(tooltip)
        pushButton_Ref_hda->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>University of applied sciences Darmstadt</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_Ref_hda->setText(QString());
        pushButton_Ref_Github->setText(QString());
        pushButton_Step_Add->setText(QCoreApplication::translate("D_MainWindow", "Add Step (+)", nullptr));
#if QT_CONFIG(shortcut)
        pushButton_Step_Add->setShortcut(QCoreApplication::translate("D_MainWindow", "+", nullptr));
#endif // QT_CONFIG(shortcut)
        label_Viewer->setText(QCoreApplication::translate("D_MainWindow", "Show Step:", nullptr));
        pushButton_Steps_Save->setText(QCoreApplication::translate("D_MainWindow", "Save Steps (Str+S)", nullptr));
#if QT_CONFIG(shortcut)
        pushButton_Steps_Save->setShortcut(QCoreApplication::translate("D_MainWindow", "Ctrl+S", nullptr));
#endif // QT_CONFIG(shortcut)
        pushButton_Steps_Update->setText(QCoreApplication::translate("D_MainWindow", "Update Steps (F5)", nullptr));
#if QT_CONFIG(tooltip)
        graphicsView_Viewer->setToolTip(QCoreApplication::translate("D_MainWindow", "<html><head/><body><p>Initialization image by Bahar Djouiai, GSI Darmstadt</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        tabWidget_Overview->setTabText(tabWidget_Overview->indexOf(Images), QCoreApplication::translate("D_MainWindow", "Images", nullptr));
        checkBox_Times_Processing->setText(QCoreApplication::translate("D_MainWindow", "Processing", nullptr));
        pushButton_Update_Times->setText(QCoreApplication::translate("D_MainWindow", "Update Times (F7)", nullptr));
        checkBox_Times_Conversion->setText(QCoreApplication::translate("D_MainWindow", "Conversion", nullptr));
        checkBox_Times_Show->setText(QCoreApplication::translate("D_MainWindow", "Show", nullptr));
        checkBox_Times_Hist->setText(QCoreApplication::translate("D_MainWindow", "Histogram", nullptr));
        label_Times_Total->setText(QCoreApplication::translate("D_MainWindow", "Total of displayed times: Xms", nullptr));
        tabWidget_Overview->setTabText(tabWidget_Overview->indexOf(Times), QCoreApplication::translate("D_MainWindow", "Times", nullptr));
        menuViewer->setTitle(QCoreApplication::translate("D_MainWindow", "Viewer", nullptr));
        menuWindow->setTitle(QCoreApplication::translate("D_MainWindow", "Window", nullptr));
        menuUpdate->setTitle(QCoreApplication::translate("D_MainWindow", "Update", nullptr));
        menuSteps->setTitle(QCoreApplication::translate("D_MainWindow", "Steps", nullptr));
        menuTests->setTitle(QCoreApplication::translate("D_MainWindow", "Tests", nullptr));
    } // retranslateUi
