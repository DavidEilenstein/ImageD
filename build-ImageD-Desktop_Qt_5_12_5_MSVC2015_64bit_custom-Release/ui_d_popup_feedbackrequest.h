...
""));
    ...
    {
        D_Popup_FeedbackRequest->setWindowTitle(QApplication::translate("D_Popup_FeedbackRequest", "Feedback Request", nullptr));
        groupBox_3->setTitle(QApplication::translate("D_Popup_FeedbackRequest", "How do you want to react to this anoying popup? Choose wisely!", nullptr));
        label->setText(QApplication::translate("D_Popup_FeedbackRequest", "Take the red pill: Send survey as e-mail", nullptr));
        pushButton_Send->setText(QString());
        label_8->setText(QApplication::translate("D_Popup_FeedbackRequest", "Take the blue pill: Remind me later", nullptr));
        pushButton_Remind->setText(QString());
        groupBox_2->setTitle(QString());
        comboBox_Department->setItemText(0, QApplication::translate("D_Popup_FeedbackRequest", "-", nullptr));
        comboBox_Department->setItemText(1, QApplication::translate("D_Popup_FeedbackRequest", "biophysics", nullptr));
        comboBox_Department->setItemText(2, QApplication::translate("D_Popup_FeedbackRequest", "physics", nullptr));
        comboBox_Department->setItemText(3, QApplication::translate("D_Popup_FeedbackRequest", "biology", nullptr));
        comboBox_Department->setItemText(4, QApplication::translate("D_Popup_FeedbackRequest", "informatics", nullptr));
        comboBox_Department->setItemText(5, QApplication::translate("D_Popup_FeedbackRequest", "image processing", nullptr));
        comboBox_Department->setItemText(6, QApplication::translate("D_Popup_FeedbackRequest", "math", nullptr));
        comboBox_Department->setItemText(7, QApplication::translate("D_Popup_FeedbackRequest", "pharma", nullptr));
        comboBox_Department->setItemText(8, QApplication::translate("D_Popup_FeedbackRequest", "medicine", nullptr));
        comboBox_Department->setItemText(9, QApplication::translate("D_Popup_FeedbackRequest", "other", nullptr));

        label_13->setText(QApplication::translate("D_Popup_FeedbackRequest", "Country", nullptr));
        label_11->setText(QApplication::translate("D_Popup_FeedbackRequest", "Department", nullptr));
        label_10->setText(QApplication::translate("D_Popup_FeedbackRequest", "User Type", nullptr));
        comboBox_Environment->setItemText(0, QApplication::translate("D_Popup_FeedbackRequest", "-", nullptr));
        comboBox_Environment->setItemText(1, QApplication::translate("D_Popup_FeedbackRequest", "institute", nullptr));
        comboBox_Environment->setItemText(2, QApplication::translate("D_Popup_FeedbackRequest", "industry", nullptr));
        comboBox_Environment->setItemText(3, QApplication::translate("D_Popup_FeedbackRequest", "university", nullptr));
        comboBox_Environment->setItemText(4, QApplication::translate("D_Popup_FeedbackRequest", "school", nullptr));
        comboBox_Environment->setItemText(5, QApplication::translate("D_Popup_FeedbackRequest", "hobby", nullptr));
        comboBox_Environment->setItemText(6, QApplication::translate("D_Popup_FeedbackRequest", "other", nullptr));

        comboBox_Country->setItemText(0, QApplication::translate("D_Popup_FeedbackRequest", "-", nullptr));

        comboBox_UserType->setItemText(0, QApplication::translate("D_Popup_FeedbackRequest", "-", nullptr));
        comboBox_UserType->setItemText(1, QApplication::translate("D_Popup_FeedbackRequest", "plugin user", nullptr));
        comboBox_UserType->setItemText(2, QApplication::translate("D_Popup_FeedbackRequest", "base programm user", nullptr));
        comboBox_UserType->setItemText(3, QApplication::translate("D_Popup_FeedbackRequest", "co-developer", nullptr));
        comboBox_UserType->setItemText(4, QApplication::translate("D_Popup_FeedbackRequest", "code-spy", nullptr));
        comboBox_UserType->setItemText(5, QApplication::translate("D_Popup_FeedbackRequest", "other", nullptr));

        comboBox_Grade->setItemText(0, QApplication::translate("D_Popup_FeedbackRequest", "-", nullptr));
        comboBox_Grade->setItemText(1, QApplication::translate("D_Popup_FeedbackRequest", "Professor", nullptr));
        comboBox_Grade->setItemText(2, QApplication::translate("D_Popup_FeedbackRequest", "Post-Doc", nullptr));
        comboBox_Grade->setItemText(3, QApplication::translate("D_Popup_FeedbackRequest", "PhD", nullptr));
        comboBox_Grade->setItemText(4, QApplication::translate("D_Popup_FeedbackRequest", "Master", nullptr));
        comboBox_Grade->setItemText(5, QApplication::translate("D_Popup_FeedbackRequest", "Bachelor", nullptr));
        comboBox_Grade->setItemText(6, QApplication::translate("D_Popup_FeedbackRequest", "Student", nullptr));
        comboBox_Grade->setItemText(7, QApplication::translate("D_Popup_FeedbackRequest", "Pupil", nullptr));
        comboBox_Grade->setItemText(8, QApplication::translate("D_Popup_FeedbackRequest", "Other", nullptr));

        comboBox_Achived->setItemText(0, QApplication::translate("D_Popup_FeedbackRequest", "-", nullptr));
        comboBox_Achived->setItemText(1, QApplication::translate("D_Popup_FeedbackRequest", "GitHub", nullptr));
        comboBox_Achived->setItemText(2, QApplication::translate("D_Popup_FeedbackRequest", "Workmate", nullptr));
        comboBox_Achived->setItemText(3, QApplication::translate("D_Popup_FeedbackRequest", "Classmate", nullptr));
        comboBox_Achived->setItemText(4, QApplication::translate("D_Popup_FeedbackRequest", "Friend", nullptr));
        comboBox_Achived->setItemText(5, QApplication::translate("D_Popup_FeedbackRequest", "Other", nullptr));

        label_12->setText(QApplication::translate("D_Popup_FeedbackRequest", "Achived", nullptr));
        label_6->setText(QApplication::translate("D_Popup_FeedbackRequest", "Grade", nullptr));
        label_9->setText(QApplication::translate("D_Popup_FeedbackRequest", "Environment", nullptr));
        label_14->setText(QApplication::translate("D_Popup_FeedbackRequest", "Category", nullptr));
        label_15->setText(QApplication::translate("D_Popup_FeedbackRequest", "Aditional information", nullptr));
        label_16->setText(QApplication::translate("D_Popup_FeedbackRequest", "Comments", nullptr));
        label_UseCount->setText(QApplication::translate("D_Popup_FeedbackRequest", "10000th", nullptr));
        label_3->setText(QApplication::translate("D_Popup_FeedbackRequest", "time :-)", nullptr));
        label_4->setText(QApplication::translate("D_Popup_FeedbackRequest", "I'm developing and publishing ImageD as OpenSource so everyone can use it to learn about and do image processing as easy as possible. ", nullptr));
        label_5->setText(QApplication::translate("D_Popup_FeedbackRequest", "It would be very nice if you can give me some feedback who you are and what you are doing with it.", nullptr));
        label_7->setText(QApplication::translate("D_Popup_FeedbackRequest", "If you spent one minute filling the survey, you don't need to see this popup again, i promise! ;-)", nullptr));
        label_2->setText(QApplication::translate("D_Popup_FeedbackRequest", "Thanks for using ImageD for the ", nullptr));
    } // retranslateUi
