...
public:
    ...
    static int      Plot_Hist_WithStats         (QChartView *pChartView, vector<vector<double>> vv_Data, double min_x, double max_x, size_t n_classes, QString name_title, QString name_x, bool uni = true, bool acc = false);
    static int      Plot_Hist_WithStats         (QChartView *pChartView, vector<vector<double>> vv_Data, double min_x, double max_x, size_t n_classes, vector<double> v_mean, vector<double> v_std, QString name_title, QString name_x, bool uni = true, bool acc = false);
    static int      Plot_Hist_WithStats_Color   (QChartView *pChartView, vector<double> v_DataHist, vector<double> v_DataColor, function<double (vector<double>)> F_ColorStat, double min_x_hist, double max_x_hist, double min_x_color, double max_x_color, size_t n_classes, double mean_hist, double std_hist, QString name_title, QString name_x, bool uni = true, bool acc = false);
