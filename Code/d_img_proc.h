...
public:
  ...
  //static int      Transformation_Distance_Rel (Mat *pMA_Out, Mat *pMA_In, int metric, int precision);
    ...
    static int      Filter_Maximum_1C_Thread_X  (Mat *pMA_Out, Mat *pMA_In, size_t mask_size_x, size_t y_start, size_t y_end);
    static int      Filter_Maximum_1C_Thread_Y  (Mat *pMA_Out, Mat *pMA_In, size_t mask_size_y, size_t x_start, size_t x_end);
