 ...
 * \details Put a <a href="https://doc.qt.io/archives/qt-4.8/qtablewidget.html">QTableWidget</a> somewhere in the user interface and pass a pointer to it to D_Table and changes made to the D_Table will be displayed in the UI
 */
