...
public:
    ...
    int     plot_Heatmap(vector<double> vData_X, vector<double> vData_Y, vector<double> vData_Z, double min_x, double max_x, bool auto_range_x, double classes_x, double min_y, double max_y, bool auto_range_y, double classes_y, size_t stat_z, bool called_internally = false);
