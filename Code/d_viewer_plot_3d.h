...
public:
    ...
    int     plot_Heatmap(vector<double> vData_X, double min_x, double max_x, bool auto_range_x, double classes_x, QString name_x, vector<double> vData_Y, double min_y, double max_y, bool auto_range_y, double classes_y, QString name_y, vector<double> vData_Z, size_t stat_z, QString name_z, bool draw_height, bool draw_wireframe, bool called_internally = false);
